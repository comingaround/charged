            ...
            <div className="container-fluid footer_top">
                <div className="row">
                    <div className="col-lg-6 col-md-12 footer_text">
                       <h3>Stay Connected with Charge</h3>
                       <h5>For updates, offers, and more, follow us on our social media channels and subscribe to our newsletter. Ride smart, ride green, ride CHARGE.</h5>
                    </div>
                        ...
                        <div className="container-fluid">
                            <div className="row">
                                <div className="col-md-4 col-sm-6">
                                    ...
                                    <ul>
                                        <li>
                                            <Link className="footer_item" to="/">Scooters</Link>
                                        </li>
                                        <li>
                                            <Link className="footer_item" to="/taxi">Taxi</Link>
                                        </li>
                                        <li>
                                            <Link className="footer_item" to="/driver">Become a driver</Link>
                                        </li>
                                    </ul>
                                </div>
                                <div className="col-md-4 col-sm-6">
                                    ...
                                    <ul>
                                        <li>
                                            <Link className="footer_item" to="/support">Contact Support</Link>
                                        </li>
                                        <li>
                                            <Link className="footer_item" to="/franchise">Start a franchise</Link>
                                        </li>
                                        <li>
                                            <Link className="footer_item" to="/locations">Locations</Link>
                                        </li>
                                        <li>
                                            <Link className="footer_item" to="/safety">Safety</Link>
                                        </li>
                                        <li>
            ...
            <div className="container-fluid footer_bottom">
                <div className="row">
                    ...
                    <div className="col-lg-6 col-md-12 footer_policy">
                        <div className="container-fluid">
                            <div className="row">
                                <a className="col-md-4 col-sm-12" href="">Languages</a>
                                <Link className="col-md-4 col-sm-12" to='/privacy'>Privacy Policy</Link>
                                <Link className="col-md-4 col-sm-12" to="/terms">Terms of Service</Link>
                            </div>
                        </div>
                    </div>
                </div>
